# BarCodeAndThemes
scan and generate QR code using ZXing.Net.Mobile.Forms nuget and apply some themes like dark theme , light theme (default) by adding two xml files (ResourcesDictionary)
